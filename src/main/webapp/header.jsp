...
<nav class="navbar navbar-expand-lg bg-body-tertiary padding-background">
    <div class="container-fluid background-header" >
        <a class="navbar-brand" href="<%=url%>/index.jsp">
            <img src="http://localhost:8080/bookStores/img/White%20Black%20Minimalist%20Brand%20Logo.png" alt="Bootstrap" height="80">
        </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
                    <li class="nav-item dropdown dropstart">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<%=url%>/khachhang/changeInformation.jsp">Thay đổi thông tin</a></li>
                            <li><a class="dropdown-item" href="<%=url%>/khachhang/changePassword.jsp">Đổi mật khẩu</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<%=url%>/khach-hang?hanhdong=sign-out">Thoát tài khoản</a></li>
                        </ul></li>
                </ul>
                <% } %>
            </form>
